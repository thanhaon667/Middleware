...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform_connections: Schema.Attribute.Relation<
      'oneToMany',
      'api::platform-connection.platform-connection'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiIntegrationCredentialIntegrationCredential
  ...
  info: {
    displayName: 'Integration Credential';
    pluralName: 'integration-credentials';
    singularName: 'integration-credential';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::integration-credential.integration-credential'
    > &
      Schema.Attribute.Private;
    misaApiUrl: Schema.Attribute.String;
    misaAppID: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zeekApiUrl: Schema.Attribute.String;
    zeekAppId: Schema.Attribute.String;
    zeekAppSecret: Schema.Attribute.String;
  };
}

export interface ApiIntegrationLogIntegrationLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'integration_logs';
  info: {
    displayName: 'IntegrationLog';
...
export interface ApiMaxThanhMaxThanh extends Struct.CollectionTypeSchema {
  collectionName: 'max_thanhs';
  info: {
    displayName: 'Max Thanh';
    pluralName: 'max-thanhs';
    singularName: 'max-thanh';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    orderStatus: Schema.Attribute.Enumeration<
      ['new', 'pending', 'sent', 'completed', 'failed']
    > &
      Schema.Attribute.DefaultTo<'new'>;
    payload: Schema.Attribute.JSON;
    platform_connection: Schema.Attribute.Relation<
      'manyToOne',
      'api::platform-connection.platform-connection'
    >;
...
export interface ApiPlatformConnectionPlatformConnection
  extends Struct.CollectionTypeSchema {
  collectionName: 'platform_connections';
  info: {
    displayName: 'PlatformConnection';
    pluralName: 'platform-connections';
    singularName: 'platform-connection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    direction: Schema.Attribute.Enumeration<['source', 'target']>;
    ...
    > &
      Schema.Attribute.Private;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    platformType: Schema.Attribute.Enumeration<['MISA', 'KIOSK', 'SAPO', 'SM']>;
    publishedAt: Schema.Attribute.DateTime;
